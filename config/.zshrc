...
alias dud='du -s *(/)'
#date for US and CN
alias adate='for i in US/Eastern Australia/Sydney Asia/{Hong_Kong,Singapore} Europe/Paris; do printf %-22s "$i:";TZ=$i date +"%m-%d %a %H:%M";done'
...
alias port='netstat -ntl'      #opening ports
